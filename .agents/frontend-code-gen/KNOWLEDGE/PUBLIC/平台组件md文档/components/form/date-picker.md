...
<div class="container">
  <div class="block">
    ...
    <tl-date-picker type="quarter" v-model="value7" placeholder="选择一个季度" @input="handleInput"
      @change="handleChange"></tl-date-picker>
  </div>
  <div class="block">
    <span class="demonstration">多个季度</span>
    <tl-date-picker type="quarters" v-model="value8" placeholder="选择多个季度" @input="handleInput"
      @change="handleChange"></tl-date-picker>
  </div>
</div>
...
| type | 显示类型 | string | year/month/date/dates/ week/datetime/datetimerange/ daterange/monthrange quarter/quarters | date |
