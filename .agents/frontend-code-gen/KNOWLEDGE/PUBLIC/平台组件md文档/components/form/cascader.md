...
<div class="block">
  ...
  <tl-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></tl-cascader>
</div>
<div class="block">
...
```html
<template>
 <tl-cascader :options="options"></tl-cascader>
</template>
...
```html
<template>
  <tl-cascader :options="options" clearable></tl-cascader>
</template>
...
```html
<template>
  <tl-cascader :options="options" :show-all-levels="false"></tl-cascader>
</template>
...
```html
<template>
   <tl-cascader :props="props"></tl-cascader>
</template>
...
```html
<template>
   <tl-cascader-panel :options="options"></tl-cascader-panel>
</template>
